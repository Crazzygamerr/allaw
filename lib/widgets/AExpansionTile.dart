...
/// [AExpansionTile] to save and restore its expanded state when it is scrolled
/// in and out of view.
///
...
/// to the [leading] and [trailing] properties of [AExpansionTile].
///
/// {@tool dartpad}
...
class AExpansionTile extends StatefulWidget {
  /// Creates a single-line [ListTile] with an expansion arrow icon that expands or collapses
  /// the tile to reveal or hide the [children]. The [initiallyExpanded] property must
  /// be non-null.
  const AExpansionTile({
    Key? key,
    this.leading,
    required this.title,
    this.subtitle,
  ...
  @override
  State<AExpansionTile> createState() => _AExpansionTileState();
}

class _AExpansionTileState extends State<AExpansionTile> with SingleTickerProviderStateMixin {
